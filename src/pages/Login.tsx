            ...
            <Card className="w-full max-w-md glass-neon active-reflection-border relative z-10 p-2 sm:p-4 rounded-3xl shadow-[0_0_50px_rgba(0,0,0,0.8)] border-primary/20 ">
                ...
                <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <Button type="submit" className="w-full bg-primary text-black font-black uppercase tracking-[0.2em] hover:bg-primary/80 transition-all h-12 mt-8 " style={{ boxShadow: "0 0 20px rgba(204,255,0,0.3)" }}>
